...
class ModelTester:
    ...
    def analyze_examples(self):
        ...
        examples = [
    # Negative
    "этот телефон полный мусор, батарея садится за час",
    "кошмарная доставка, посылка пришла с повреждениями",
    "не понравилось обслуживание, грубые продавцы",
    "фильм ужасный, зря потратил деньги",
    "качество одежды отвратительное, нитки торчат",
    
    # Positive
    "потрясающий сервис, всё супер быстро",
    "качественный продукт, доволен покупкой",
    "замечательная книга, прочитал на одном дыхании",
    "отличный кофе, вкус идеальный",
    "супер фильм, эмоции на максимум",
    
    # Neutral
    "товар пришёл в целости, ничего необычного",
    "работает, как и ожидал, без проблем",
    "среднее качество, можно использовать",
    "доставка стандартная, без задержек",
    "услуга оказана, но ничего особенного"
]
...
if __name__ == "__main__":
    ...
    model_path = "/home/chelovek/Документы/work/classifier7772finalycutBIIIGBOOOOS299"
